            ...
            <thead>
              ...
              <tr className="border-b bg-muted/30">
                ...
                {DAYS.map((day) => {
                  ...
                  return (
                    <td key={day.key + "-comment"} colSpan={2} className="py-1 px-0">
                      <input
                        type="text"
                        value={value}
                        onChange={(e) => setLocalDayComments((prev) => ({ ...prev, [day.key]: e.target.value }))}
                        placeholder="—"
                        className={`w-full px-0.5 py-0.5 text-[10px] text-center rounded border focus:outline-none focus:ring-1 focus:ring-accent ${
