  ...
  return (
    <div className="min-h-screen bg-background">
      <FnacHeader title={t("teamDay.title")} subtitle={t("teamDay.subtitle")} icon={Users}>
        <Button variant="outline" size="sm" className="no-print h-8 text-xs gap-1.5 border-foreground/20 text-foreground hover:bg-foreground/10" onClick={() => window.print()}>
